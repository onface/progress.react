...
/******/ 	__webpack_require__.p = "/progress.react/0.1.5";
/******/
...
var Costom = function (_React$Component) {
    _inherits(Costom, _React$Component);

    function Costom(props) {
        _classCallCheck(this, Costom);

        var _this = _possibleConstructorReturn(this, (Costom.__proto__ || Object.getPrototypeOf(Costom)).call(this, props));
    ...
    _createClass(Costom, [{
        ...
        value: function render() {
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                'div',
                { className: 'costomDemo' },
                'type\xA0:\xA0',
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'select',
                    { value: state.type, onChange: function onChange(e) {
                            self.change('type', e.target.value);
                        } },
                    __webpack_require__("./node_modules/react/index.js").createElement(
                        'option',
                        null,
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'select',
                    { value: state.status, onChange: function onChange(e) {
                            self.change('status', e.target.value);
                        } },
                    __webpack_require__("./node_modules/react/index.js").createElement(
                        'option',
                        null,
                ...
                '\u2002 active\xA0:\xA0',
                __webpack_require__("./node_modules/react/index.js").createElement('input', { checked: state.active, type: 'checkbox', onChange: function onChange(e) {
                        self.change('active', !state.active);
                    } }),
                '\u2002 info\xA0:\xA0',
                __webpack_require__("./node_modules/react/index.js").createElement('input', { checked: state.info, type: 'checkbox', onChange: function onChange(e) {
                        self.change('info', !state.info);
                    } }),
                '\u2002 insetText\xA0:\xA0',
                __webpack_require__("./node_modules/react/index.js").createElement('input', { checked: state.insetText, type: 'checkbox', onChange: function onChange(e) {
                        self.change('insetText', !state.insetText);
                    } }),
                '\u2002 barColor\xA0:\xA0',
                __webpack_require__("./node_modules/react/index.js").createElement('input', {
                    style: { width: '150px' },
                ...
                '\u2002 dashboard\xA0:\xA0',
                __webpack_require__("./node_modules/react/index.js").createElement('input', { checked: state.dashboard, type: 'checkbox', onChange: function onChange(e) {
                        self.change('dashboard', !state.dashboard);
                    } }),
                '\u2002',
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    ...
                    __webpack_require__("./node_modules/react/index.js").createElement(Progress, state)
                )
            );
        }
    }]);
...
Costom = __webpack_require__("./node_modules/react-hot-loader/lib/index.js").hot(module)(Costom);
...
var Costom = __webpack_require__("./doc/Costom.js");
ReactDOM.render(__webpack_require__("./node_modules/react/index.js").createElement(Costom, null), document.getElementById('costom-demo'));

/***/ }),

/***/ "./lib/ProgressGroup.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _getColor = __webpack_require__("./lib/getColor.js");

var _accuracy = __webpack_require__("./lib/accuracy.js");
...
var ProgressGroup = function (_Component) {
    ...
    function ProgressGroup(props) {
        ...
        var _this = _possibleConstructorReturn(this, (ProgressGroup.__proto__ || Object.getPrototypeOf(ProgressGroup)).call(this, props));
    ...
    _createClass(ProgressGroup, [{
        key: "getFloatArray",
        value: function getFloatArray(numArray) {
            var self = this;
            var accurArray = void 0;
            if (typeof self.props.accuracy == 'number') {
                ...
                accurArray = (0, _extend2.default)(true, accurArray, self.props.accuracy);
            }
            return numArray.map(function (item, i) {
                return (0, _accuracy2.default)(item, accurArray[i]);
            });
        }
    }, {
        key: "render",
        value: function render() {
            ...
            var percentArray = self.getFloatArray(self.props.percent);
            ...
            var lineStyle = (_lineStyle = {}, _defineProperty(_lineStyle, pcls + "-line", true), _defineProperty(_lineStyle, pcls + "-line--thick", self.props.type === 'inset'), _defineProperty(_lineStyle, pcls + "-line--loading", self.props.active), _lineStyle);
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                self.props.type === 'line' || self.props.type === 'inset' ? __webpack_require__("./node_modules/react/index.js").createElement(
                    ...
                    __webpack_require__("./node_modules/react/index.js").createElement(
                        "div",
                        { className: pcls + "-line-box" },
                        __webpack_require__("./node_modules/react/index.js").createElement(
                            "div",
                            { className: pcls + "-line-box-track",
                                style: (0, _getColor.getBgColor)(self.props.barMarkColor)
                            },
                            percentArray.map(function (item, i) {
                                var style = { width: item + '%' };
                                if (self.props.barColor[i]) {
                                    style = _lodash2.default.assign(style, (0, _getColor.getBarColor)(self.props.barColor[i]));
                                }
                                return __webpack_require__("./node_modules/react/index.js").createElement(
                                    "div",
                                    {
                                    ...
                                    self.props.type !== 'inset' || insetText[i] === false ? null : __webpack_require__("./node_modules/react/index.js").createElement(
                                        "span",
                                        { className: pcls + "-line-box-track-bar-text" },
                                        typeof insetText[i] === 'function' ? insetText(item) : item + "%"
                                    )
                                );
                            })
                        )
                    ),
                    self.props.info === false ? null : __webpack_require__("./node_modules/react/index.js").createElement(
                        "div",
                        { className: self.props.prefixClassName + "-line-info" },
                        typeof self.props.info === 'function' ? self.props.info(percentArray[0]) : percentArray[0] + "%"
                    )
                ) : null
            );
        }
...
__webpack_require__("./lib/ProgressGroupProps.js").default(ProgressGroup);
...
exports.default = function (app) {
    ...
    app.propTypes = {
        ...
        percent: _propTypes2.default.arrayOf(_propTypes2.default.number),
        accuracy: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.arrayOf(_propTypes2.default.number)]),
        type: _propTypes2.default.string,
        status: _propTypes2.default.string,
        active: _propTypes2.default.bool,
        info: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.func]),
        insetText: _propTypes2.default.arrayOf(_propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.func])),
        barColor: _propTypes2.default.arrayOf(_propTypes2.default.string)
    };
    app.propExample = {
        percent: example([20], // 这样等同只有一条进度条, 那么就用回Progress组件吧,Progress支持更多样式类型
        [99.99, 60, 24.1] // 三条进度条叠加
        [(90, 80, 70, 60, 50)] // 如果超过三条以上进度条叠加, 就应该考虑是不是不应该使用这种组件了
        ),
        accuracy: example(2, // => [2, 2, 2, ...] 每一条进度条都精确到小数后2位
        [2] // => [2, 0, 0, ...] 第一条进度条都精确到小数后2位,其他进度条精确度采用默认值
        [(2, 3, 1)] // 第一条进度条精确到小数后2位,第二条精确到后3位,第三条精确到后1位
        ),
        type: example('line', // 横向进度条
        'inset' // 横向进度条 - 可显示内置内容
        ),
        status: example('default', // 进度条以及进度条右侧或环内显示内容 为 蓝色
        'error', // 进度条以及进度条右侧或环内显示内容 为 红色
        'success' // 进度条以及进度条右侧或环内显示内容 为 绿色
        ),
        active: example(true, false),
        info: example(false, // 不显示
        true, // 默认显示百分比
        function (percent) {
            return __webpack_require__("./node_modules/react/index.js").createElement(
                'span',
        ...
        barColor: example(['red', '#000', 'rgb(204,204,204)', 'rgba(230,25,224,0.3)'],
        // 第一条红,第二条黑,第三条灰,第四条粉
        ['unknow', 'green']
        // 第一条无法识别的颜色会被组件三个主色调中随机一个替代,
        // 第二条绿, 
        // 如果配置了两条进度条以上,其他进度条会和第一条一样被随机替代,
        // 但放心是间隔替代,不会是相邻重复颜色,您故意配置与主色调相同的颜色混在其中, 对不起,我没做那么细致
        )
    };
};
...
var getAccuracy = function getAccuracy(precent, accuracy) {

    var num = Math.max(Math.min(100, precent), 0) || 0;

    var accur = Math.pow(10, accuracy);

    if (/\./.test(num)) {
        // 浮点数处理
        var decimal = String(num).replace(/^\d+\.(\d+)$/, '$1');
        if (decimal.length < accuracy) {
            var fil = new Array(accuracy - decimal.length).fill('0').join('');
            num = String(num) + fil;
        } else {
...
var getColor = {
	getBgColor: function getBgColor(color, type) {
		if (type == 'circle') {
			return { stroke: color };
		}
		return { background: color };
	},
	getBarColor: function getBarColor(color, type) {
		if (type == 'circle') {
			return { stroke: color };
		}
...
var Progress = (_temp = _class = function (_Component) {
    ...
    _createClass(Progress, [{
        key: "getSvgPercent",
        value: function getSvgPercent(percent) {
            var self = this;
            var diam = 94;
            var girth = Math.PI * diam;
            girth = self.props.dashboard ? girth * 0.75 : girth;
            var offset = girth * (100 - percent) / 100;
        ...
        value: function render() {
            ...
            var percent = (0, _accuracy2.default)(self.props.percent, self.props.accuracy);

            var lineStyle = (_lineStyle = {}, _defineProperty(_lineStyle, pcls + "-line", true), _defineProperty(_lineStyle, pcls + "-line--thick", self.props.type === 'inset'), _defineProperty(_lineStyle, pcls + "-line--loading", self.props.active), _lineStyle);
            var circleStyle = (_circleStyle = {}, _defineProperty(_circleStyle, pcls + "-circle", true), _defineProperty(_circleStyle, pcls + "-circle--dashboard", self.props.dashboard), _circleStyle);
            if (self.props.status) {
                lineStyle[pcls + "-line--" + self.props.status] = true;
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                self.props.type === 'line' || self.props.type === 'inset' ? __webpack_require__("./node_modules/react/index.js").createElement(
                    ...
                    __webpack_require__("./node_modules/react/index.js").createElement(
                        ...
                        __webpack_require__("./node_modules/react/index.js").createElement(
                            ...
                            __webpack_require__("./node_modules/react/index.js").createElement(
                                ...
                                {
                                    className: pcls + "-line-box-track-bar",
                                    style: _lodash2.default.assign({ width: percent + '%' }, (0, _getColor.getBarColor)(self.props.barColor))
                                },
                                self.props.type !== 'inset' || self.props.insetText === false ? null : __webpack_require__("./node_modules/react/index.js").createElement(
                                    "span",
                                    { className: pcls + "-line-box-track-bar-text" },
                                    typeof self.props.insetText === 'function' ? self.props.insetText(percent) : percent + "%"
                                )
                            )
                        )
                    ),
                    self.props.info === false ? null : __webpack_require__("./node_modules/react/index.js").createElement(
                        "div",
                        { className: pcls + "-line-info" },
                        typeof self.props.info === 'function' ? self.props.info(percent) : percent + "%"
                    )
                ) : null,
                self.props.type === 'circle' ? __webpack_require__("./node_modules/react/index.js").createElement(
                    "div",
                    _defineProperty({ className: pcls + "-circle"
                    ...
                    __webpack_require__("./node_modules/react/index.js").createElement(
                        ...
                        __webpack_require__("./node_modules/react/index.js").createElement("path", { className: pcls + "-circle-svg-outer",
                            d: "M 50,50 m 0,-47 a 47,47 0 1 1 0,94 a 47,47 0 1 1 0,-94",
                            style: (0, _getColor.getBgColor)(self.props.barMarkColor, 'circle')
                        }),
                        __webpack_require__("./node_modules/react/index.js").createElement("path", { className: pcls + "-circle-svg-inner",
                            d: "M 50,50 m 0,-47 a 47,47 0 1 1 0,94 a 47,47 0 1 1 0,-94",
                            style: _lodash2.default.assign(self.getSvgPercent(percent), (0, _getColor.getBarColor)(self.props.barColor, 'circle'))
                        })
                    ),
                    self.props.info === false ? null : __webpack_require__("./node_modules/react/index.js").createElement(
                        "div",
                        { className: pcls + "-circle-info" },
                        typeof self.props.info === 'function' ? self.props.info(percent) : percent + "%"
                    )
                ) : null
            );
    ...
    return Progress;
}(_react.Component), _class.ProgressGroup = __webpack_require__("./lib/ProgressGroup.js"), _class.getAccuracy = __webpack_require__("./lib/accuracy.js"), _temp);


__webpack_require__("./lib/props.js").default(Progress);
...
exports.default = function (app) {
    ...
    app.propTypes = {
        ...
        active: _propTypes2.default.bool,
        info: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.func]),
        insetText: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.func]),
        barColor: _propTypes2.default.string,
        dashboard: _propTypes2.default.bool
    };
    app.propExample = {
        percent: example(20, // int
        99.99, // float
        -12, // => 0 会被转化为有效数据0
        120 // => 100 会被转化为有效数据100
        ),
        accuracy: example(2, // 精确到小数后2位
        ...
        insetText: example(true, // 默认显示内置内容为百分比
        false, // 不显示
        function (percent) {
            return __webpack_require__("./node_modules/react/index.js").createElement(
                'span',
        ...
        barColor: example('red', '#999', 'rgb(0,0,0)', 'rgba(200,200,200,0.3)', 'unknowColor', // 如果设置的颜色无法识别, 将会在组件自身提供的三中主色调中随机一个替代
        ['red', 'green']),
        barMarkColor: example('red', '#999', 'rgb(0,0,0)', 'rgba(200,200,200,0.3)'),
        dashboard: example(true, // 显示为仪表盘样式 ( 只有在'type:circle'时才有效 )
        false)
    };
};
...
module.exports = __webpack_require__("./doc/costom.demo.js");
